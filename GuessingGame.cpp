...
const int MAX = 26;
char alphabetGuess,alphabetAnswer;
  ...
  do{
    ...
    switch(option){
          ...
          case 1: // Word
            ...
            switch(diff){ // Selecting Difficulity
              case 1:
                system("cls");
                attemptGuess = 0;
                alphabetAnswer = alphabet[rand() % 7];
              ...
              case 2:
                system("cls");
                attemptGuess = 0;
                alphabetAnswer = alphabet[rand() % 13];
                while(alphabetAnswer != alphabetGuess) {
                  system("cls");
                  cout << "         VS Computer" << endl;
                  cout << "----------------------------" << endl;
              ...
              case 3:
                system("cls");
                attemptGuess = 0;
                alphabetAnswer = alphabet[rand() % 19];
                while(alphabetAnswer != alphabetGuess) {
                  system("cls");
                  cout << "         VS Computer" << endl;
                  cout << "----------------------------" << endl;
              ...
              case 4:
                system("cls");
                attemptGuess = 0;
                alphabetAnswer = alphabet[rand() % MAX];
                while(alphabetAnswer != alphabetGuess) {
                  system("cls");
                  cout << "         VS Computer" << endl;
                  cout << "----------------------------" << endl;
      ...
      case 2: // VS player
        ...
        switch(mode){ // Selecting mode
          ...
          case 2: // Number (1-100)
            ...
            if(playerNumberAnswer > 100 || playerNumberAnswer < 0) {
      ...
      case 3: // Rules
        ...
        cout << "| 4. For VS Player, the answer must be  |" << endl;
        cout << "| above 0 and below 100                 |" << endl;
        cout << "| 5. Have Fun :D                        |" << endl;
        cout << "-----------------------------------------" << endl;
        system("pause");
        break;
    }
